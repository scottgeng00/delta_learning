...
def train(args):
    ...
    if strategy.check_if_finished(args.save_path):
        print(f"Training already finished, at {args.save_path} skipping...")
        return
    ...
    strategy.save_model(
        model, tokenizer, args.save_path, write_finished=True,
        cleanup_checkpoints=True, ckpt_dir=args.ckpt_path
    )
